	...
	public function getOrder($order_id) {
		...
		if ($order_query->num_rows) {
			...
			return array(
				...
				'shipping_taxno'			=> $order_query->row['shipping_taxno'],
				//sender_address
				'sender_fullname'      => $order_query->row['sender_fullname'],
				'sender_telephone'      => $order_query->row['sender_telephone'],
				'sender_company'        => $order_query->row['sender_company'],
				'sender_address_1'      => $order_query->row['sender_address_1'],
				'sender_address_2'      => $order_query->row['sender_address_2'],
				'sender_postcode'       => $order_query->row['sender_postcode'],
				'sender_city_id'        => $order_query->row['sender_city_id'],
				'sender_city'           => $order_query->row['sender_city'],
				'sender_zone_id'        => $order_query->row['sender_zone_id'],
				'sender_zone'           => $order_query->row['sender_zone'],
				'sender_zone_code'      => $sender_zone_code,
				'sender_country_id'     => $order_query->row['sender_country_id'],
				'sender_country'        => $order_query->row['sender_country'],
				'sender_county_id'      => $order_query->row['sender_county_id'],
				'sender_county'         => $order_query->row['sender_county'],
				'sender_address_format' => $order_query->row['sender_address_format'],
				'sender_custom_field'   => json_decode($order_query->row['sender_custom_field'], true),
				'sender_method'         => $order_query->row['sender_method'],
				'sender_code'           => $order_query->row['sender_code'],
