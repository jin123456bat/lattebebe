...
class ModelLocalisationCity extends Model
{
    ...
    {
        $this->db->query("INSERT INTO " . DB_PREFIX . "city SET name = '" . $this->db->escape($data['name']) . "', up_id='" . (int)$data['parent_id'] . "', zone_id = '" . (int)$data['zone_id'] . "', status = '" . (int)$data['status'] . "',sort_order='".(int)$data['sort_order']."'");
    ...
    public function getCityBySortOrder($sort_order)
    {
    	$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "city WHERE sort_order = '" . (int)$sort_order . "' limit 1");
