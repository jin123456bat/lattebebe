	...
	public function info() {
		...
		if ($order_info) {
			...
			if (!empty($order_info['shipping_method'])) {
				...
				//sender address
				$data['sender_address'] = address_format($order_info, $order_info['sender_address_format'], 'sender');
			} else {
				// Payment Address
		...
		foreach ($orders as $order_id) {
			...
			if ($order_info && $order_info['shipping_code']) {
				...
				$data['orders'][] = array(
					...
					'sender_fullname' => $order_info['sender_fullname'],
					'sender_telephone' => $order_info['sender_telephone'],
					'sender_address' => address_format($order_info, $order_info['sender_address_format'], 'sender'),
				);
			}
		}
