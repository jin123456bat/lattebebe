...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_sender_default_zone']))
		{
			$data['config_sender_default_zone'] = $this->request->post['config_sender_default_zone'];
		}
		else
		{
			$data['config_sender_default_zone'] = $this->config->get('config_sender_default_zone');
		}
		
		if (isset($this->request->post['config_sender_default_city']))
		{
			$data['config_sender_default_city'] = $this->request->post['config_sender_default_city'];
		}
		else
		{
			$data['config_sender_default_city'] = $this->config->get('config_sender_default_city');
		}
		
		if (isset($this->request->post['config_sender_default_county']))
		{
			$data['config_sender_default_county'] = $this->request->post['config_sender_default_county'];
		}
		else
		{
			$data['config_sender_default_county'] = $this->config->get('config_sender_default_county');
		}
		
		if (isset($this->request->post['config_sender_default_address']))
		{
			$data['config_sender_default_address'] = $this->request->post['config_sender_default_address'];
		}
		else
		{
			$data['config_sender_default_address'] = $this->config->get('config_sender_default_address');
		}
		
		if (isset($this->request->post['config_sender_default_fullname']))
		{
			$data['config_sender_default_fullname'] = $this->request->post['config_sender_default_fullname'];
		}
		else
		{
			$data['config_sender_default_fullname'] = $this->config->get('config_sender_default_fullname');
		}
		
		if (isset($this->request->post['config_sender_default_telephone']))
		{
			$data['config_sender_default_telephone'] = $this->request->post['config_sender_default_telephone'];
		}
		else
		{
			$data['config_sender_default_telephone'] = $this->config->get('config_sender_default_telephone');
		}
