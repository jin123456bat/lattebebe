...
$_['text_success']					= 'Dettagli account Realex  modificato correttamente!';
...
$_['text_secret']					= 'Segreta condivisa';
...
$_['text_capture_ok_order']			= 'Acquisizione avvenuta con successo, stato ordine aggiornato con - depositato';
...
$_['text_ip_message']				= 'Inserire l&apos;indirizzo IP al gestore account Realex prima di andare live';
...
$_['entry_auto_settle']				= 'Tipo Pagamento';
$_['entry_tss_check']				= 'Controlli TSS';
$_['entry_card_data_status']		= 'Salvataggio Informazioni Carta';
...
$_['entry_status_decline_pending']	= 'Declina - autorizzazione offline';
$_['entry_status_decline_stolen']	= 'Declina - carta persa o rubata';
$_['entry_status_decline_bank']		= 'Declina - errore banca';
...
$_['help_card_select']				= 'Chiedere all&apos;utente di scegliere il tipo di carta prima di essere redirezionato';
...
$_['help_liability']				= 'Accettazione di responsabilit&agrave; significa che continuerete ad accettare pagamenti quando un utente fallisce 3D Secure';
$_['help_card_data_status']			= 'Salva su file le ultime 4 cifre della carta, scadenza, nome, tipo e banca di emissione';
