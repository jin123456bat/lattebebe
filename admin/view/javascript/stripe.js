//==============================================================================
// Stripe Payment Gateway Pro v302.6
// 
...
function stripeCapture(element, charge_amount, charge_id) {
	...
	if (amount != null && amount > 0) {
		...
		$.get('index.php?route=extension/payment/stripe/capture&charge_id=' + charge_id + '&amount=' + amount + token,
			function(error) {
				$('#please-wait').remove();
				if (error) {
					alert(error);
