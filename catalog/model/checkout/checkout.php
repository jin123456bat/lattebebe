...
class ModelCheckoutCheckout extends Model {
	...
	public function createOrder() {
		...
		$order_data = array(
			...
			'sender_county'           => '',
			'sender_county_id'        => '',
			'sender_address_format'   => '',
			'sender_custom_field'     => array(),
			'sender_method'           => '',
			'sender_code'             => '',
		...
		$order_data['shipping_taxno'] = $this->session->data['shipping_address']['taxno'];
		foreach (['payment', 'shipping','sender'] as $type) {
